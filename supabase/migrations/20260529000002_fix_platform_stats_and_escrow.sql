-- 20260529000002_fix_platform_stats_and_escrow.sql
-- IMPROVED PLATFORM STATS AND ESCROW CALCULATIONS FOR ADMIN HUB
...
BEGIN
    ...
    -- 2. Dedicated Escrow aggregations (excluding cancelled and completed unless explicitly matching status)
    -- Active Escrow: bookings where escrow is 'held' or 'locked' (frozen)
